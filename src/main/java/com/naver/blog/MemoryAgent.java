...
public class MemoryAgent {
	public static long mBytes = 1024 * 1024;
	
    public static void premain(String agentArgs, Instrumentation instrumentation) {
    	Timer timer = new Timer("MemoryAgent Timer", true);
    ...
    public static class MemoryTimeTask extends TimerTask {

		@Override
		public void run() {
			Runtime currentRuntime = Runtime.getRuntime();
			long total = currentRuntime.totalMemory() / mBytes;
			long free = currentRuntime.freeMemory() / mBytes;
			System.out.println(
	                String.format("Memory Total: %sMB, Free: %sMB, Use: %sMB",
	                		total,
	                		free,
	                		total - free));
